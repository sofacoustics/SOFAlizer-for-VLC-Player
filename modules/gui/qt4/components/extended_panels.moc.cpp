...
**
** Created: Wed Sep 25 14:11:03 2013
...
static const uint qt_meta_data_Sofalizer[] = {
...
static const char qt_meta_stringdata_Sofalizer[] = {
    "Sofalizer\0"
};

void Sofalizer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    Q_UNUSED(_o);
    Q_UNUSED(_id);
    Q_UNUSED(_c);
...
const QMetaObjectExtraData Sofalizer::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject Sofalizer::staticMetaObject = {
    { &AudioFilterControlWidget::staticMetaObject, qt_meta_stringdata_Sofalizer,
      qt_meta_data_Sofalizer, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &Sofalizer::getStaticMetaObject() { return staticMetaObject; }
#endif //Q_NO_DATA_RELOCATION

const QMetaObject *Sofalizer::metaObject() const
{
    return QObject::d_ptr->metaObject ? QObject::d_ptr->metaObject : &staticMetaObject;
}

void *Sofalizer::qt_metacast(const char *_clname)
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Sofalizer))
        return static_cast<void*>(const_cast< Sofalizer*>(this));
    return AudioFilterControlWidget::qt_metacast(_clname);
}

int Sofalizer::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = AudioFilterControlWidget::qt_metacall(_c, _id, _a);
    if (_id < 0)
        return _id;
